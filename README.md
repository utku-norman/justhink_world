...
A human learner participates in the pedagogical scenario through an application ([justhink_app]). The robot behaviour is generated by [justhink_robot]. They serve as [ROS] nodes that communicate via the custom ROS headers in [justhink_msgs].
